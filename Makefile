...
lint-py:  ## lint python with ruff
	python -m ruff check nbprint_slack
	python -m ruff format --check nbprint_slack
...
fix-py:  ## autoformat python code with ruff
	python -m ruff check --fix nbprint_slack
	python -m ruff format nbprint_slack
...
test:  ## run python tests
	python -m pytest -v nbprint_slack/tests

coverage:  ## run tests and collect test coverage
	python -m pytest -v nbprint_slack/tests --cov=nbprint_slack --cov-report term-missing --cov-report xml
